...
<form onSubmit={handleSubmit}>
  ...
  <div class="grid md:grid-cols-2 md:gap-6">
    ...
    <div class="relative z-0 mb-6 w-full group">
        ...
        <select value={quantity} onChange={(e) => setQuantity(e.target.value)} className="px-5 py-1 ml-[10%] mt-[10%] text-sm font-medium text-center text-black rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300">
                        {
