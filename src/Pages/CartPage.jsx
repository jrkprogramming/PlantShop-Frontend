...
const CartPage = () => {
  ...
  return (
    <div>
        ...
        <div class="rounded-lg mt-[5%] ml-[10%] w-[80%] h-[80%] bg-black dark:bg-gray-900 bg-opacity-90 top-0 overflow-y-auto overflow-x-hidden fixed " id="chec-div">
        
        <div class="w-full absolute z-10 right-0 h-full overflow-x-hidden overflow-y-auto transform translate-x-0 transition ease-in-out duration-700" id="checkout">
            ...
            <div class="lg:w-96 md:w-8/12 w-full bg-gray-100 dark:bg-gray-900 h-full">
                ...
                <div>
                    ...
                    <div class="flex items-center justify-between pt-5 ">
                    <p class=" leading-none text-gray-800 dark:text-white text-3xl">Subtotal</p>
