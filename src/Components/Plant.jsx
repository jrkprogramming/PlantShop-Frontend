...
const Plant = ({ plant }) => {
  return (
    ...
    <div class="grid  max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 m-5">
      <a href="#">
        <img
          class="object-contain p-8 rounded-t-lg "
          src={plant.image}
          alt=""
        />
      </a>
      <div class="px-5 pb-5">
        ...
        <div class="flex justify-between items-center">
          ...
          <a
            ...
            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-500 dark:hover:bg-stone-400 dark:focus:ring-blue-800"
          >
            MORE
          </a>
        </div>
